...
Сегодня поговорим об инженерах и о том, как всего этого добиться через проведения тех интервью внешних кандидатов и внутренних сотрудников.
...
Основной тезис - у инженера нет границ и, если для нужд своего продукту аналитику нужно написать код или разработчику создать документацию, то они это должны иметь возможность это сделать.